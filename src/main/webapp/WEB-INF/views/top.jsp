		...
		<div class="modal-body" align="center">
			...
			<div class="mb-3">
		        ...
		        <c:if test="${userId eq null}">
			      	<a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=4433f36e8b4d7a77d2fdd1a85312d7fe&redirect_uri=http://43.200.109.77:8080/seoulforyou/kakaoLogin.do&response_type=code">
